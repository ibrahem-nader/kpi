...
const HELP_TEXT = {
  ...
  'Estimate accuracy': 'Tracked time compared with estimated time. For scoring, this uses a softer scale: 90+=5, 75+=4, 60+=3, 45+=2, below 45=1.',
  'On-time delivery': 'Percentage of due-dated completed tasks finished on or before their due date. For scoring, this uses a softer scale: 90+=5, 75+=4, 60+=3, 45+=2, below 45=1.',
  ...
  'Bug fix rate': 'Percentage of bug tasks that reached a done status. For scoring, this uses a softer scale: 90+=5, 75+=4, 60+=3, 45+=2, below 45=1.',
  ...
  'Completion rate': 'Percentage of tasks in the selected scope that reached a done status. For scoring, this uses a softer scale: 90+=5, 75+=4, 60+=3, 45+=2, below 45=1.',
