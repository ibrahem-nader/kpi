...
const HELP_TEXT = {
  ...
  'Estimate accuracy': 'Tracked time compared with estimated time. For scoring, this uses a more lenient scale: 90+=5, 80+=4, 70+=3, 60+=2, below 60=1.',
  'On-time delivery': 'Percentage of due-dated completed tasks finished on or before their due date. For scoring, this uses a more lenient scale: 90+=5, 80+=4, 70+=3, 60+=2, below 60=1.',
  ...
  'Bug fix rate': 'Percentage of bug tasks that reached a done status.',
